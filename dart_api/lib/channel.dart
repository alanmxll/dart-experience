...
import 'package:dart_api/model/movement_model.dart';
import 'package:dart_api/routers/users_router.dart';
...
class DartApiChannel extends ApplicationChannel {
  ...
  Future prepare() async {
    ...
    final config = DartApiConfiguration(options.configurationFilePath);
...
class DartApiConfiguration extends Configuration {
  DartApiConfiguration(String fileName) : super.fromFile(File(fileName));
